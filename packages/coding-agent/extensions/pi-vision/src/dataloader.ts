...
import { type DescriberDeps, runBatch } from "./describer.js";
import { imageHash } from "./image.js";
import { type ExtractedImage, UNAVAILABLE, type VisionConfig, wrapDescription } from "./index.js";
...
export type VisionModelResolver = (registry: ModelRegistry, ref: string) => Model<Api> | null;
