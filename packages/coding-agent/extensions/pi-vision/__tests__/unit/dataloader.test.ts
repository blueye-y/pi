...
import { DescriptionLoader, type LoaderDeps, UNAVAILABLE } from "../../src/dataloader.js";
...
function makeLoader(overrides: Partial<LoaderDeps> = {}, cfgOverrides: Partial<VisionConfig> = {}): DescriptionLoader {
